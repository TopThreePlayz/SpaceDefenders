...
var meteorX, meteorY, meteorWidth, meteorHeight;
meteorX = 300;
meteorY = 0;
meteorWidth = 50;
meteorHeight = 50;
...
drawBackground();
 goodGuy();
  ...
  ctx.drawImage(meteor, meteorX, meteorY, meteorWidth, meteorHeight);
  ...
  if(checkCollisions(width, height, x, y, meteorWidth, meteorHeight, meteorX, meteorY)){
...
function next(){
window.location.href = "https://hackingtons.io/posts/ASiYG2bAwrnpK49pv"
}
...
function repositionMeteor(){
   meteorY = 0;
  meteorX = Math.random() * 600;
}
